...
VALUES ('Avatar', '2009', '120', 'English', '2010-12-1', 'UK'),
       ...
       ('Terminator', '1984', '200', 'English', '1984-10-26', 'US'),
       ('The Dark Crystal', '1982', '150', 'English', '1982-12-17', 'UK'),
       ('Annie Hall', '1977', '150', 'English', '1977-08-17', 'US')
;
...
VALUES (6, 1, 'first hero role'),
       ...
       (11, 21, 'figurant'),
       (6, 23, 'second adversary role'),
       (9, 24, 'second hero role'),
       (10, 25, 'first hero role'),
       (12, 25, 'first hero role'),
       (13, 25, 'second hero role')
...
from movie
         join rating on movie.mov_id = rating.mov_id
where rev_stars is null and num_o_ratings is null;
...
/* Vraag 9 */
select distinct act_id, act_fname, act_lname
from actor
...
/* Vraag 11 */
select mov_title, mov_rel_country
from movie
...
select distinct act_fname, act_lname, mov_year
from actor
         join movie_cast mc on actor.act_id = mc.act_id
...
select dir_fname, dir_lname, count(gen_title) as genreNbr
from director
